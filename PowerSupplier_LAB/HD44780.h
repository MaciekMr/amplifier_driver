...
//using namespace nm_DS1267;	
	...
	*/
	...
	class LCD_Config{
		...
		public:
			LCD_Config(pin_port p1, pin_port p2, pin_port p3, pin_port p4, pin_port p5, pin_port p6);
			void LCD_SetModel(unsigned char model);
	...
	class HD44780_LCD{
		...
		public:
			HD44780_LCD(pin_port p1, pin_port p2, pin_port p3, pin_port p4, pin_port p5, pin_port p6);
